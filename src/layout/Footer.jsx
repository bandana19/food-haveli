...
const Footer = () => {
 ...
 <Fragment>
   <div className='footer'>
        ...
        <h1 className='name'>USING HTML AND CSS</h1>
        <div className='footer-app'>
            <h1 className='titel'>CodingLab</h1>
            <ul className='image-box'>
                <li className='fec'><i class='fa fa-facebook fe-ico'></i></li>
                <li className='t-icon'><img className='twitter' src='/img/twitter.webp'/></li>
                <li className='ins-icon'><img  src='/img/insta.webp'/></li>
                <li className='ni-icon'><img src='/img/in-logo.png'/></li>
                <li className='yo-icon'><img src='/img/you.jpg'/></li>
             ...
             <div className='app-box'>
                ...
                <li><img className='image-2' src='/img/twitter.webp'/></li>
                <li><img className='image-3' src='/img/insta.webp'/></li>
                <li className='image-in'><img className='image-4' src='/img/in-logo.png'/></li>
                </div>
                }
            </ul>
            <hr/>
            ...
            <div className='top-footer'>
              <p className='text'>Copyright 2021 CodingLab. All right reserved</p>
              <p className='police'>Privocy police.  Terms & condition</p>
            </div>
        </div>
